...
// BELOW IS A VERSION WITH UNNECESSARY ABSOLUTE STYLING REMOVED: BUG - VIDEO BACKGROUND DOES NOT COVER FULL WIDTH
...
//       className="relative flex h-[90vh] shrink-0 flex-col items-center justify-center"
//     >
//       {/* Absolute container for the video background */}
...
//       {/* Relative container for the text */}
//       <div className="relative  max-w-screen-xl text-center  z-20">
//         <h1 className="mb-4 text-4xl font-extrabold tracking-tight leading-none text-gray-900 md:text-5xl lg:text-6xl dark:text-white">
//           Let go of your mind. Let go of your body. Find your Self.
//         </h1>
//         <h2 className="mb-8 text-lg font-normal text-gray-500 lg:text-xl sm:px-16 xl:px-48 dark:text-gray-600">
