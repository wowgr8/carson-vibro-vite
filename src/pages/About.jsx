        ...
        >
          ...
          <main className="mt-10 mx-auto max-w-7xl px-4 sm:mt-12 sm:px-6 md:mt-16 lg:mt-20 lg:px-8 xl:mt-28">
            <div className="sm:text-center md:text-center lg:text-left">
              <h2 className="my-6 text-2xl tracking-tight font-extrabold text-yellow-400 sm:text-3xl md:text-4xl">
                MEET YOUR PRACTITIONER
              </h2>

              <p className="text-white drop-shadow-[0_5.2px_3.2px_rgba(0,0,0,0.8)]">
