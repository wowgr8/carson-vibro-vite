...
function Footer() {
  return (
    <div className="bg-blue-950 border-t border-blue-900">
      <div className="max-w-screen-xl py-1 px-4 sm:px-6 dark:text-white text-gray-800 sm:flex justify-between mx-auto">
        ...
        <div className="p-5 sm:w-7/12 flex flex-col items-center justify-center">
          ...
          <h3 className="text-xl dark:text-white text-gray-800">
            4204 SE Boise st. Portland Oregon 97206
          </h3>
        </div>
        {/* Map section */}
        <div className="p-5 sm:w-5/12">
          <div className="relative pt-[60%] overflow-hidden border-4 dark:border-yellow-300 border-indigo-600">
            <iframe
      ...
      <div className="flex py-2 m-auto dark:text-white text-gray-800 text-sm flex-col items-center border-t border-blue-900 max-w-screen-xl">
